...
public class Soccer_Trigger : MonoBehaviour {
    //Main 씬의 Controller (right)오브젝트에 삽입된 스크립트이다.
    ...
    void Update()
    {
        ...
        {//바이브 컨트롤러의 trigger 버튼이 클릭됐을 때 Soccer 씬으로 이동한다.
            isTrigger = true;
        ...
        {   //터치패드를 클릭할 경우 Soccer_Chart 씬으로 이동한다.
            SceneManager.LoadScene("Soccer_Chart");
        }
        else
        {
            isTrigger = false;
